...
# Only define POS models if POS module is installed
try:
    from odoo.addons.point_of_sale.models.pos_payment_method import PosPaymentMethod as BasePosPaymentMethod
    POS_AVAILABLE = True
except ImportError:
    POS_AVAILABLE = False
...
if POS_AVAILABLE:
    ...
    # Create dummy classes when POS is not available
    _logger.info("POS module not available - Vipps POS functionality disabled")